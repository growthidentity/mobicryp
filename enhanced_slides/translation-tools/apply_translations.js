...
function applyTranslationsToFile(filePath, slideId) {
  ...
  const thaiFilePath = filePath.replace('.html', '_th.html');
  try {
...
function createThaiIndex() {
  ...
  <div class="language-switcher">
    <a href="index.html">English</a> | <a href="index_th.html">ไทย</a>
  </div>`);
  ...
  const thaiIndexPath = path.join(__dirname, '..', 'index_th.html');
  try {
